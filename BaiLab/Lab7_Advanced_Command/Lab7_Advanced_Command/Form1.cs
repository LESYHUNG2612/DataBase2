...
namespace Lab7_Advanced_Command
{
    public partial class Form1 : Form
    {
        ...
        //khai bao chuoi lien ket toi sever
        string connectSTR = @"Data Source = MyLaptop; Initial Catalog = RestaurantManagement; Integrated Security = True";
        public Form1()
        {
            InitializeComponent();
        }
        //doc du lieu danh sach mon an tu sql lên
