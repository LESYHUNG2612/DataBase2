...
namespace CSDL
{
    public partial class PhanQuyen : Form
    {
        ...
        {
            InitializeComponent();
            cnn = new SqlConnection("Data Source=.;Initial Catalog=QuanLyThuVienSachCaNhan;Integrated Security=True");
        }
        //dinh nghia cac ham xu ky
        private void dangky()
        {
        ...
        private void PhanQuyen_KeyDown(object sender, KeyEventArgs e)
        {
